#!/bin/sh
# nohup bash 6-lstmeval.sh shobhika Minus > reports/6-lstmeval-shobhika-Minus.txt &
# nohup bash 6-lstmeval.sh shreelipi Minus > reports/6-lstmeval-shreelipi-Minus.txt &
